        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AddressInfos_Customers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Sales_Sources_SourceId",
                        column: x => x.SourceId,
                        principalTable: "Sources",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemLead", x => new { x.ItemsId, x.LeadId });
                    table.ForeignKey(
                        name: "FK_ItemLead_Items_ItemsId",
                        column: x => x.ItemsId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemLead_Leads_LeadId",
                        column: x => x.LeadId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AddressInfos_CustomerId",
                table: "AddressInfos",
                column: "CustomerId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sales_SourceId",
                table: "Sales",
                column: "SourceId");

            migrationBuilder.CreateIndex(
                name: "IX_Statuses_SaleId",
                table: "Statuses",
                column: "SaleId");
        }
